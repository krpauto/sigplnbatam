...
<div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Peta ODP</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">ODP</a></li>
              <li class="breadcrumb-item active" aria-current="page">Peta ODP</li>
            </ol>
          </div>
          ...
          <?php $this->load->view('layout/alert') ?>
              <div class="card">
                ...
                <div class="input-group ">
                  <input type="text" class="form-control p-4 pl-1 pr-1" value="<?= @$_GET['key'] ?>" name="key" placeholder="Masukkan Nama/Alamat/Status" aria-label="Cari" aria-describedby="basic-addon2">
                  ...
                  <script>
                    ...
                    else
                    {
                      ...
                      for (let i = 0; i < markers.length; i++){
                        ...
                        '<div class="photo">' +
                        '<img src="../uploads/odp/' + foto[k] + '" alt="userphoto" width="85px" height="100%" class="float-left object-fit-cover rounded">' +
                        '</div>' +
                        '</div>' +
